  ...
  texts: {
    ...
    features: {
      ...
      card2: {
        ...
        subtitle:
          "Atuação desde a primeira instância até os tribunais superiores.",
        description: (
          <div>
            A_Definir
            <br />
      ...
      card3: {
        ...
        subtitle:
          "Presença ao lado do cliente desde o contato com a autoridade policial.",
        description: (
          <div>
            A_Definir
            <br />
      ...
      card5: {
        ...
        subtitle:
          "Garantia dos direitos do preso e combate a abusos de autoridade.",
        description: (
          <div>
            A_Definir
            <br />
      ...
      card6: {
        ...
        subtitle:
          "Medidas para reverter condenações injustas e assegurar a liberdade.",
        description: (
          <div>
            A_Definir
            <br />
      ...
      card7: {
        ...
        subtitle:
          "Elaboração de recursos e pedidos liminares em defesa dos direitos.",
        description: (
          <div>
            A_Definir
            <br />
